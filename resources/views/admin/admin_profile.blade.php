                            ...
                            <div class="col-lg-6">
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="name" type="text" value="{{ $profileData->name }}" id="name">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="phone" type="text" value="{{ $profileData->phone }}" id="telephone">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mt-lg-0">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="photo" type="file" id="profile-image">
                                    </div>
                                    <div class="mb-3">
                                        <img
                                            id = "show-image"
